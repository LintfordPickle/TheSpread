...
public class GameLostScreen extends MenuScreen {
	...
	public static final String SCREEN_TITLE = "You've Lost :(";
	...
	public GameLostScreen(ScreenManager pScreenManager, int pGameEntityID) {
		...
		MenuEntry lNextGame = new MenuEntry(pScreenManager, lNavLayout, "New Map");
